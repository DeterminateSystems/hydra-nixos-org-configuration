...
resource "hydra_jobset" "nix_maintenance-2_31" {
  ...
  state       = "enabled"
  visible     = true
  name        = "maintenance-2.31"
  type        = "flake"
  description = "2.31 release branch"

  flake_uri = "github:NixOS/nix/2.31-maintenance"
...
resource "hydra_jobset" "nix_maintenance-2_32" {
  project     = hydra_project.nix.name
  state       = "enabled"
  visible     = true
  name        = "maintenance-2.32"
  type        = "flake"
  description = "2.32 release branch"

  flake_uri = "github:NixOS/nix/2.32-maintenance"
...
resource "hydra_jobset" "nix_maintenance-2_33" {
  ...
  state       = "enabled"
  visible     = true
  name        = "maintenance-2.33"
  type        = "flake"
  description = "2.33 release branch"

  flake_uri = "github:NixOS/nix/2.33-maintenance"
...
resource "hydra_jobset" "nix_maintenance-2_34" {
  ...
  state       = "enabled"
  visible     = true
  name        = "maintenance-2.34"
  type        = "flake"
  description = "2.34 release branch"

  flake_uri = "github:NixOS/nix/2.34-maintenance"
...
resource "hydra_jobset" "nix_pr-13785" {
  project     = hydra_project.nix.name
  state       = "disabled"
  visible     = false
  name        = "pr-13785"
  type        = "flake"
  description = "PR #13785"
