...
resource "hydra_jobset" "nixpkgs_nixpkgs-25_11-darwin" {
  project     = hydra_project.nixpkgs.name
  state       = "enabled"
  visible     = true
  name        = "nixpkgs-25.11-darwin"
  type        = "legacy"
  description = "Darwin builds for the NixOS 25.11 release."
...
resource "hydra_jobset" "nixpkgs_pr-440456-gcc15" {
  project     = hydra_project.nixpkgs.name
  state       = "disabled"
  visible     = false
  name        = "pr-440456-gcc15"
  type        = "legacy"
  description = "Testing PR #440456: gcc: 14 → 15"
  ...
  input {
    name              = "nixpkgs"
    type              = "git"
    value             = "https://github.com/fabianhjr/nixpkgs.git gcc-15"
    notify_committers = false
  }
...
resource "hydra_jobset" "nixpkgs_python-updates" {
  ...
  name        = "python-updates"
  type        = "legacy"
  description = "Staging ground for large updates to the python package set"
...
resource "hydra_jobset" "nixpkgs_staging-25_05" {
  project     = hydra_project.nixpkgs.name
  state       = "disabled"
  visible     = true
  name        = "staging-25.05"
  type        = "legacy"
  description = "staging-25.05 branch"
  ...
  input {
    name              = "nixpkgs"
    type              = "git"
    value             = "https://github.com/nixos/nixpkgs.git staging-25.05"
    notify_committers = false
  }
...
resource "hydra_jobset" "nixpkgs_staging-25_11" {
  project     = hydra_project.nixpkgs.name
  state       = "enabled"
  visible     = true
  name        = "staging-25.11"
  type        = "legacy"
  description = "staging-25.11 branch"
  ...
  input {
    name              = "nixpkgs"
    type              = "git"
    value             = "https://github.com/nixos/nixpkgs.git staging-25.11"
    notify_committers = false
  }
...
resource "hydra_jobset" "nixpkgs_staging-next-25_11" {
  project     = hydra_project.nixpkgs.name
  state       = "enabled"
  visible     = true
  name        = "staging-next-25.11"
  type        = "legacy"
  description = "staging-next-25.11 branch"
...
resource "hydra_jobset" "nixpkgs_unstable" {
  project     = hydra_project.nixpkgs.name
  state       = "enabled"
  visible     = true
  name        = "unstable"
