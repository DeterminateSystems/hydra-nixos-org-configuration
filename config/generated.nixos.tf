...
resource "hydra_jobset" "nixos_pr-435781-systemd-stage1" {
  ...
  input {
    name              = "nixpkgs"
    type              = "git"
    value             = "https://github.com/ElvishJerricco/nixpkgs.git default-systemd-initrd"
    notify_committers = false
  }
...
resource "hydra_jobset" "nixos_release-25_05" {
  project     = hydra_project.nixos.name
  state       = "disabled"
  visible     = false
  name        = "release-25.05"
  type        = "legacy"
  description = "NixOS 25.05 release branch"
...
resource "hydra_jobset" "nixos_release-25_05-small" {
  project     = hydra_project.nixos.name
  state       = "disabled"
  visible     = false
  name        = "release-25.05-small"
  type        = "legacy"
  description = "NixOS 25.05 release branch"
...
resource "hydra_jobset" "nixos_release-25_11" {
  project     = hydra_project.nixos.name
  state       = "enabled"
  visible     = true
  name        = "release-25.11"
  type        = "legacy"
  description = "NixOS 25.11 release branch"
...
resource "hydra_jobset" "nixos_release-25_11-small" {
  project     = hydra_project.nixos.name
  state       = "enabled"
  visible     = true
  name        = "release-25.11-small"
  type        = "legacy"
  description = "NixOS 25.11 release branch"
...
resource "hydra_jobset" "nixos_release-26_05" {
  project     = hydra_project.nixos.name
  state       = "enabled"
  visible     = true
  name        = "release-26.05"
...
resource "hydra_jobset" "nixos_release-26_05-small" {
  project     = hydra_project.nixos.name
  state       = "enabled"
  visible     = true
  name        = "release-26.05-small"
  type        = "legacy"
  description = "NixOS 26.05 release branch"
...
resource "hydra_jobset" "nixos_staging-next-25_11-small" {
  project     = hydra_project.nixos.name
  state       = "enabled"
  visible     = true
  name        = "staging-next-25.11-small"
  type        = "legacy"
  description = "staging-next-25.11 branch, small jobset"
...
resource "hydra_jobset" "nixos_staging-next-26_05-small" {
  project     = hydra_project.nixos.name
  state       = "enabled"
  visible     = true
  name        = "staging-next-26.05-small"
  type        = "legacy"
  description = "staging-next-26.05 branch, small jobset"
...
resource "hydra_jobset" "nixos_test-rocm-pkgs" {
  project     = hydra_project.nixos.name
  state       = "disabled"
  visible     = false
  name        = "test-rocm-pkgs"
  type        = "legacy"
  description = "Testing the effect of recursing into pkgsRocm on the evaluator"
  ...
  input {
    name              = "nixpkgs"
    type              = "git"
    value             = "https://github.com/LunNova/nixpkgs.git push-qtolrxrtvptr"
    notify_committers = false
  }
...
resource "hydra_jobset" "nixos_unstable" {
  project     = hydra_project.nixos.name
  state       = "enabled"
  visible     = true
  name        = "unstable"
